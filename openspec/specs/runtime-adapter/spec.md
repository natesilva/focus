...
Defines the `RuntimeAdapter` interface and the factory function that selects the appropriate backend (Docker or Apple Containers) at runtime, enabling all container operations to be performed through a single abstract interface.
