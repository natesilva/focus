...
Defines how the CLI surfaces errors to the user — ensuring that known failure modes produce clean, actionable messages while unexpected internal errors preserve enough detail for debugging.
