...
Defines the runtime lifecycle of focus containers: attaching to running containers, handling config changes, stopping containers, reporting status, and pruning orphaned containers.
